...
#define IFO_DFT_FILE_NAME		_T("Config")
#define IFO_DFT_FILE_EXT		_T("ini")
...
public:
	...
	//! 构造函数
	CIniFileOperations(LPCTSTR lpszFilePath);
	//! 构造函数
	CIniFileOperations(LPCTSTR lpszFileName, LPCTSTR lpszFileExt);
	//! 析构函数
	~CIniFileOperations(void);
